...
export const config = {
	...
	ARGENTINA_DATOS_API_URL: process.env.ARGENTINA_DATOS_API_URL || 'https://api.argentinadatos.com',
	ARS_USD_EXCHANGE_HOUSE: process.env.ARS_USD_EXCHANGE_HOUSE || 'blue',
	CRON_SYNC_ARS_USD_RATE: process.env.CRON_SYNC_ARS_USD_RATE || '0 0,12 * * *',
	...
	SECURITY_GEO_ENRICHMENT_ENABLED: parseBoolean(process.env.SECURITY_GEO_ENRICHMENT_ENABLED, true),
	SECURITY_GEO_ENRICHMENT_TIMEOUT_MS: parseIntegerInRange(process.env.SECURITY_GEO_ENRICHMENT_TIMEOUT_MS, 1500, 100, 10_000),
